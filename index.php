...
<!-- Mirrored from massive.markup.themebucket.net/shop-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Sep 2017 04:54:47 GMT -->
<head>
...
<body>
    ...
    <div class="wrapper">
    	<?php 
    	include_once './_share/header.php';
    	 ?>

        <!--page title start-->
        <section class="page-title">
            <div class="container">
                <h4 class="text-uppercase">Shop - 2 Column</h4>
                <ol class="breadcrumb">
                    <li><a href="#">Home</a>
                    </li>
                    <li><a href="#">Product</a>
                    </li>
                    <li class="active">Shop - 2 Column</li>
                </ol>
            </div>
        </section>
        <!--page title end-->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="product-list">
                                        ...
                                        <div class="product-price">
                                            <del><?php echo number_format($pro['price'], 0, '', ',') ?> vnđ</del> <?php echo number_format($pro['sale_price'], 0, '', ',') ?> vnđ
                                        </div>
    ...
    <?php 
    include_once './_share/script.php';
     ?>
</body>


<!-- Mirrored from massive.markup.themebucket.net/shop-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 08 Sep 2017 04:55:09 GMT -->
</html>
